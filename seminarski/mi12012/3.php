<?php session_start(); //stavljamo na svaku stranicu koja mora da bude svesna postojanja seija?> 
<!DOCTYPE html 
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<?php 
			...
			include('inc/ad.inc'); // Funkcije vezane za stranica za registraciju korisnika
	...
	<body lang='SR' onload='ajaxPozivi(); checkCookie();'>
		<div id="omotac">
			...
			<?php dravAd(); //iscrtavanje slika (linkova) ka forumima?>
